...
context_dependencies:
  worldbuilding: [cartographer, economist, historian, anthropologist]
  narrative: []
---
...
- **Factions**: Real polities have organized internal factions — court parties, regional blocs, religious wings, military patrons. Name them.
- **Institutions that constrain the ruler**: Councils, charters, customary rights, religious authority, military veto. What can the ruler NOT do unilaterally?
- **The bureaucracy**: Who actually executes decisions? Civil servants, eunuchs, ministers, governors? Their incentives shape policy more than the ruler's intent.
- **Patronage and clientelism**: How do offices, lands, monopolies get distributed? Patronage is the daily currency of pre-modern politics.
...
- **Forgetting administrative reality.** A king can't enforce a decree without a bureaucracy that wants to enforce it.
