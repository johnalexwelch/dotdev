...
## Runtime vs Curriculum

OMC is the runtime layer. Skills are the curriculum.
...
**Keyword trigger bypass:**
OMC keyword triggers (`autopilot`, `ralph`, `ultrawork`, `ccg`, `ralplan`, `deep interview`, `deslop`, `deep-analyze`, `tdd`, `deepsearch`, `ultrathink`) are direct OMC invocations. They do NOT go through `workflow-router`. This is intentional — they are power-user shortcuts for known OMC capabilities.
