...
Status: deprecated. The vault path (~/.claude/docs or ~/Documents/Home/) can be set in CLAUDE.md directly. No skill needed for a single file write target.

- Replaced by: a one-line vault path note in CLAUDE.md
- Date: 2026-06-10
