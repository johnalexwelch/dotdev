...
Status: deprecated. These usage rules should be embedded directly in the brain context block that prompt-builder or brain-ops injects into agent prompts — not delivered as a separate skill.

- Replaced by: embed a <brain-usage-rules> section inside injected brain context (prompt-builder / brain-ops change needed)
- Date: 2026-06-10
