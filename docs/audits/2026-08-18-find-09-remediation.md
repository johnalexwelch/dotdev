...
The local primary checkout scans identically post-cleanup. Follow-up (out of scope here): add a gitleaks allowlist / detect-secrets baseline entries for these known-benign paths so future full-history scans are zero-noise.
