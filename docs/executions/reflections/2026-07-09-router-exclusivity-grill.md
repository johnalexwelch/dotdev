...
_Both target the narrowest owner (the canonical grill engine); `wayfinder` grilling tickets inherit them. No new skill warranted — this is wording, not a new pattern._
