...
_None — "recover prior work" pattern passes quality gate but is better solved by tooling (semantic session search) than a skill. The manual grep approach is not worth codifying._
