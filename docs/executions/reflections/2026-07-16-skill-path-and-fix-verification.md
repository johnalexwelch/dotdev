...
*Note: already folded into `handoff/SKILL.md` this session (committed + pushed + codex-mirrored): the corrected `--absolute-git-dir` derivation, the two-part naming clause, and a compute-then-literal note.*
