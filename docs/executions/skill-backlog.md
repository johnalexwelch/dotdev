...
<!-- 2026-08-18 harvest (Track D of D-006): +20 reflections (08-04-airflow → 08-17-ae-232; the 08-17 file read from local main b7aea54, unpushed at harvest). NO DISPATCH this run — harvest+triage only per D-006 track decisions. D-006 (decision-log.md) structurally consumes several themes: rows recorded `accepted` w/ "consumed by D-006 dN" instead of duplicate dispatches — new SB-097/098/104/109/117 + prior SB-048/SB-055/SB-061 flipped. Ground-truth closed: mlops-engineer cloud-ci patterns (landed `915ab21`, local main, unpushed), herdr-auto-naming (built as pi extension in-session). New clusters C42–C48. Entry-enforcement (D-006 d18, evidence 3MF sessions 08-11) and ledger-durability (d19, evidence AE-232 08-17) had no checkbox proposals — consumed at the lesson level, noted on C46/C45 only. -->
<!-- Lane-1 ground-truth note 2026-08-18: PRs #104–#113 all MERGED per gh (mergedAt 2026-07-27T22:40–22:41Z UTC); the "merged 2026-07-28" wording above is off by one calendar day (UTC) but substantively correct. -->
...
| **C42** | **Proxy-vs-ground-truth before fix / lock / durable write** | **5** | **3 open (+2 consumed)** | **HIGHEST of Aug wave — 5× (08-04 airflow, 08-06 iceberg, 08-10 pergamon models, 08-11 3mf, 08-11 rowan-litellm). Grill pre-lock + diagnose-evidence slices consumed by D-006 d21b/d10; residual = habits.md line, i-have-adhd verification rule, decision-log evidence-path note** |
| **C43** | **External-tool/format compatibility research-first (spec-compliance ≠ tool support)** | **2** | **1** | **high — 2× 3MF sessions (08-11); one extraction candidate absorbs the workflow-debug/build-one checkbox slices** |
| **C44** | **Forge-neutral delivery tooling (Forgejo ≠ GitHub)** | **4** | **2 open (+1 consumed)** | **high — 4× (08-10 entity, 08-11 forgejo-mcp, 08-11 workboard, 08-12 operator). Finalize/checked-field slice consumed by D-006 d20 (forge.sh); residual = handoff env-assumption notes, remote-outage habit** |
| **C45** | **Primary-checkout / worktree stale-state reconcile (kin C15/C31/C32)** | **3** | **1 open (+1 consumed)** | **med-high — 08-04 warren drift, 08-12 operator worktree-behind, 08-17 ae-232 reset loss (d19 ledger durability consumed the state.yaml slice at lesson level)** |
| **C46** | **Entry enforcement / skill discipline under pressure** | **2** | **0** | **fully consumed by D-006 d18 (warn→block hook) — evidence: 3MF sessions 08-11, three ignored workflow reminders; no checkbox rows, lesson-level consumption** |
| **C47** | **Ponytail scope calibration (blast-radius opt-in; YAGNI ≠ correctness)** | **2** | **2** | **high — 08-05 enforcement rollback ×3 cycles, 08-13 dedup deferral reversal; same owner, one dispatch** |
| **C48** | **Inherited-constraint / paradigm questioning before continued investment** | **1** | **2** | **med — 08-10 warren pivot (weeks of CodeMirror work on an unvalidated Obsidian assumption); pivot-assessment extraction in C-ext** |
...
| SB-024 | 2026-07-17 | 1 | 2026-07-17-skill-pipeline-habits-openwiki | workflow-skill (DELETED) | Claude-runtime breakage → hard report | med | superseded | — | C8 | **2026-08-25: workflow-skill deleted this session** | implement | C8 | **Ground-truth 2026-07-24: still OPEN — workflow-skill:71 still soft "report it"** |
...
| SB-036 | 2026-07-19 | 2 | multi | CLAUDE.md | habits.md pointer | high | folded | — | C9 | **2026-08-25: Already in global CLAUDE.md (this session)** | fold | C9 | Fold into SB-028 — 2nd-session evidence |
...
| SB-040 | 2026-07-20 | 1 | 2026-07-20-path-guard-phase3 | execute-phase (DELETED) | Git-history precedent stale | med | superseded | — | C16 | **2026-08-25: execute-phase deleted this session** | implement | C16 | **Ground-truth 2026-07-24: still OPEN — no such habit in habits.md/execute-phase** |
...
| SB-048 | 2026-07-24 | 2 | 2026-07-19-skill-compliance-no-mechanical-enforcement, 2026-07-21-pergamon-phase1-bootstrap-gotchas | workflow-finalize (+ habits.md) | Self-check: absence of the required WORKFLOW_STEPS ledger in the current response = self-detected halt; skill gates are advisory, silent non-display = halt | high | accepted | — | C22 | **Consumed by D-006 d2/d6 (2026-08-18): ledger.sh checked gates + blocking hooks close C22 fully; lands via Phase 0 kernel + hook rollout** |
...
| SB-054 | 2026-07-24 | 1 | 2026-07-24-arch-stack-merge-queue-finalize | improve-codebase-architecture | Distinguish "missing-tests → write red→green, proceed" from "invariant-is-judgment-call → genuine human gate" before marking a slice human-gated | high | implemented | — | C28 | **2026-08-25: grilling loop checkpoint added** |
| SB-055 | 2026-07-24 | 1 | 2026-07-23-workflow-review-merged-state | workflow-review (reviewer-roster.md + SKILL.md) | Model-floor: specialist lanes may run below opus floor; use opus general `reviewer` + per-lane brief; capture `model_used` per lane, re-run below-floor | high | accepted | — | C29 | **Consumed by D-006 d13 (2026-08-18): per-lane verdict/sha256/model_used digests; `stamp review` fails below floor (closes C29); lands via review deep pass** |
...
| SB-061 | 2026-07-24 | 1 | 2026-07-19-skill-compliance-no-mechanical-enforcement | taskflow (gate phases) | Migrate load-bearing skill gates into mechanical `taskflow` `gate` phases | med | accepted | — | C22 | **Consumed by D-006 d2 (2026-08-18): workflow-ledger kernel is the mechanical-gate substrate, superseding taskflow-gate migration; lands via Phase 0** |
...
| SB-071 | 2026-07-28 | 1 | multi | workflow-finalize | Clean-state exit gate | high | folded | — | C31 | **2026-08-25: Covered by Hook Rule C (PR body gate)** | implement | C31 | dispatch |
...
| SB-075 | 2026-07-28 | 1 | multi | cleanup-delivery | Approval phrase + will-not-touch list | med | folded | — | C31 | **2026-08-25: Covered by session cleanup work** | implement | C31 | dispatch |
...
| SB-079 | 2026-07-28 | 2 | multi | git-guardrails (DELETED) | gh auth switch pattern | low | superseded | — | C33 | **2026-08-25: git-guardrails deleted this session** | implement | C33 | habits.md proactive already landed |
...
| SB-081 | 2026-07-28 | 2 | multi | workflow-build-one (DELETED) | Delegate after exhausting progress | med | superseded | — | C34 | **2026-08-25: workflow-build-one deleted (use workflow-deliver)** | implement | C34 | dispatch |
| SB-082 | 2026-07-28 | 1 | 2026-07-27-pergamon-openbao-secret-key | workflow-debug (DELETED) | Live check before repeating analysis | high | superseded | — | C34 | **2026-08-25: workflow-debug deleted this session** | implement | C34 | dispatch |
| SB-083 | 2026-07-28 | 1 | multi | habits.md | Discard queued closeout on pivot | med | folded | — | C34 | **2026-08-25: Covered by i-have-adhd always-on (restate state every turn)** | implement | C34 | dispatch (habits.md group) |
...
| SB-085 | 2026-07-28 | 1 | multi | habits.md | Never suppress mutating stderr | high | folded | — | C36 | **2026-08-25: Covered by workflow-guard hook infrastructure** | implement | C36 | fold w/ SB-083 into one habits.md edit |
...
| SB-088 | 2026-07-28 | 1 | 2026-07-27-pergamon-phase6-backlog-cleanup | workflow-autonomous-backlog (DELETED) | Existing-PRD fast path | high | superseded | — | C38 | **2026-08-25: workflow-autonomous-backlog deleted this session** | implement | C38 | dispatch |
...
| SB-097 | 2026-08-18 | 2 | 2026-08-06-ground-truth-before-locking-infra | grill-with-docs | Pre-lock gate: decisions checkable in-repo (substrate/engine/integration/wiring) must be verified against authoritative repo/running state before locking or durable fan-out | high | accepted | — | C42 | **Consumed by D-006 d21b, lands via grill-with-docs floor pass.** Ground-truth 2026-08-18: gate not yet in SKILL.md |
| SB-098 | 2026-08-18 | 1 | 2026-08-04-airflow-resilience-evidence | workflow-debug | Never prescribe a fix for a task failure without its error_detail/log; counts+config rank, logs diagnose | med | accepted | — | C42 | **Consumed by D-006 d10 (`stamp diagnose` requires captured repro + attested root cause), lands via workflow-deliver migration** |
| SB-099 | 2026-08-18 | 3 | 2026-08-06-ground-truth-before-locking-infra, 2026-08-11-3mf-multicolor-slicer-compatibility, 2026-08-10-litellm-pergamon-deployment | docs/agents/habits.md | One durable line: proxy (spec/prior/verbal/"mesh is valid"/config example) vs ground truth (repo, running state, target tool, live API) — verify in first iteration, before fixes or durable fan-out | high | implemented | — | C42 | **2026-08-25: proxy-vs-ground-truth line added to habits.md** |
| SB-100 | 2026-08-18 | 1 | 2026-08-11-rowan-litellm-routing | i-have-adhd | Rule: when claiming a fix, show the verification command + output; never say "fixed" without evidence (3 untested "fixed" claims that session) | high | implemented | — | C42 | **2026-08-25: Rule 9 (show verification evidence) added** |
| SB-101 | 2026-08-18 | 1 | 2026-08-06-ground-truth-before-locking-infra | decision-log (or wayfinder) | Infra-substrate resolutions should cite the repo evidence path grounding them (verified-fact vs prior distinguishable later) | low | new | defer | C42 | Singleton nicety; revisit with C42 dispatch |
| SB-102 | 2026-08-18 | 2 | 2026-08-11-3mf-multicolor-slicer-compatibility, 2026-08-11-3mf-export-debugging | external-tool-compatibility (skill-extraction) | Research target-tool format interpretation + obtain known-working reference output BEFORE implementing; byte-compare when stuck; spec-compliance ≠ tool support | high | implemented | — | C43 | **Implemented in PR #166** as standalone model-invoked skill (dispatch resolved the standalone-vs-build-one q: standalone; it must fire across any implementation flow, not only build-one). Gate: googleable=No/specific=Yes/real-effort=Yes |
| SB-103 | 2026-08-18 | 1 | 2026-08-04-airflow-resilience-evidence | airflow-failure-rca (skill-extraction) | Evidence-first Airflow failure triage: rank by counts/cascade → per-offender error_detail log pull (map_index for mapped tasks; try_number vs max_tries retry-exhaustion) → classify (bug / monitor-correct / transient) before any fix | high | implemented | — | C-ext | **Implemented in PR #166** as catalog-tier (disable-model-invocation) judgment skill. Open q (`error_detail` generic vs dojo listener extension) encoded as the skill's verify-first Step 0 rather than resolved. Overturned an 8-item retry-based audit |
| SB-104 | 2026-08-18 | 2 | 2026-08-12-operator-console-cli, 2026-08-11-forgejo-mcp-ci-integration | workflow-finalize | Detect origin ≠ github.com → dispatch via git-forge/API instead of `gh` (Forgejo branch) | med | accepted | — | C44 | **Consumed by D-006 d20 (forge.sh shim for checked fields + merge-gate regex incl. tea/curl), lands via Phase 0/finalize migration.** Ground-truth 2026-08-18: no forge handling in SKILL.md yet |
| SB-105 | 2026-08-18 | 2 | 2026-08-11-forgejo-mcp-ci-integration, 2026-08-10-litellm-rowan-migration | handoff | Env-assumption notes: when origin is self-hosted (Forgejo/Gitea) state that `gh` won't work + name the right tool; always include IP alongside LAN hostnames (resuming machine may lack /etc/hosts entry) | med | implemented | — | C44 | **2026-08-25: env-assumption rule added to Rules section** |
| SB-106 | 2026-08-18 | 1 | 2026-08-10-warren-entity-pivot | docs/agents/habits.md | When a git remote is unreachable (Forgejo outage), prefer smaller incremental pushes when it returns over accumulating large divergence | low | new | defer | C44 | Singleton; kin of merge-over-rebase lesson (informational) |
| SB-107 | 2026-08-18 | 1 | 2026-08-11-workboard-sync-github-forgejo-divergence | reconcile-git-remotes (skill-extraction) | Dual-remote reconcile workflow: fetch both, compare histories both directions, fast-forward or cherry-pick onto authoritative, push back | med | new | defer | C-ext | Gate passed but revisit after D-006 d20 forge.sh lands (may absorb the detection half); force-push policy open q |
| SB-108 | 2026-08-18 | 1 | 2026-08-04-warren-prd3-primary-checkout-drift | cleanup-delivery (+ handoff step-0 fold) | Offer the reconcile ACTION for stale-and-behind primary checkout (safety-patch then `reset --hard` to authoritative remote, approval-gated) — today it only reports; handoff step-0 asserts primary sync (folded) | med | implemented | — | C45 | **2026-08-25: Step 4.5 reconcile-primary action added** |
| SB-109 | 2026-08-18 | 1 | 2026-08-12-operator-console-cli | workflow-build-one | Pre-commit check: is worktree behind origin/main after PRs merged mid-session (stash/reset dance; `--wait` work lost) | low | accepted | — | C45 | **Consumed by D-006 d2 (`reconcile` ledger-vs-git + freshness checked fields), lands via Phase 0** |
| SB-110 | 2026-08-18 | 1 | 2026-08-17-ae-232-mlflow-infra-patterns | mlops-engineer | Check `cloud-ci-automation/repo_config/` for company infra patterns before proposing GH Actions/environments/IAM; classification-models.yaml as ML-repo-without-K8s template | high | implemented | — | CZ | **Ground-truth 2026-08-18: landed as `915ab21` (local main, unpushed at harvest) — both checkboxes covered** |
| SB-111 | 2026-08-18 | 1 | 2026-08-05-dbt-doc-skill-scope-creep | ponytail persona / docs/agents/habits.md | When lazy-ladder output is ENFORCEMENT (CI gate/lint/check blocking others), default opt-in single-target scope and confirm blast radius before repo-wide ("please do" approves the idea, not the blast radius) | med | implemented | — | C47 | **2026-08-25: blast-radius rule added to habits.md** |
| SB-112 | 2026-08-18 | 1 | 2026-08-13-yagni-correctness-boundary | ponytail persona / docs/agents/habits.md | YAGNI applies to features/optimizations, NOT correctness guards (dedup, validation, trust-boundary error handling earn keep from line 1; "document the upgrade path" is a YAGNI smell) | high | implemented | — | C47 | **2026-08-25: YAGNI-boundary rule added to habits.md** |
| SB-113 | 2026-08-18 | 1 | 2026-08-10-warren-pivot-insight | docs/agents/habits.md | Before accepting a tool/format/paradigm as a constraint, verify it's a real requirement, not "what the user happened to be using" (Obsidian assumption cost weeks) | high | implemented | — | C48 | **2026-08-25: inherited-constraint rule added to habits.md** |
| SB-114 | 2026-08-18 | 1 | 2026-08-10-warren-pivot-insight | workflow-feature (DELETED) | Goal vs approach checkpoint | med | superseded | — | C48 | **2026-08-25: workflow-feature deleted this session** | defer | C48 | Kin of SB-113; revisit when C48 dispatches (may fold into the habits line) |
| SB-115 | 2026-08-18 | 1 | 2026-08-10-warren-pivot-insight | pivot-assessment (skill-extraction) | Paradigm-pivot assessment: identify inherited constraint → verify real requirement → sketch alternative → keep/gut/add inventory → pivot-vs-fresh-vs-continue effort estimate → user decides | med | new | defer | C-ext | Gate passed but singleton; `zoom-out` (perspective shifts) is adjacent, not covering — resolve overlap at dispatch; author's trigger-threshold open q stands |
| SB-116 | 2026-08-18 | 1 | 2026-08-11-forgejo-mcp-ci-integration | setup-mcp-server (skill-extraction) | MCP server setup workflow: install binary → verify → locate config (`~/.pi/agent/mcp.json`) → add entry (env literal, lifecycle) → manual --cli test → note restart requirement | med | new | implement | C-ext | Gate: googleable=No (Pi-specific)/specific=Yes/real-effort=Yes; verified live on forgejo-mcp |
| SB-117 | 2026-08-18 | 1 | 2026-08-11-rowan-soak-parallel-taskflow | grill-with-docs (delegate mode) | Prefer single-agent executor with "wear specialist hats" over multi-phase specialist routing in taskflow delegate mode — orchestration overhead without decision-quality gain (100% consensus, 11 decisions) | med | accepted | — | C-misc | **Consumed by D-006 d21a as logged counter-evidence/watch-item: two-lane TDD pilot collapses to single-lane + empty-test-diff check if it reproduces overhead-without-value** |
| SB-118 | 2026-08-18 | 1 | 2026-08-11-rowan-soak-parallel-taskflow | taskflow | Document reduce-phase `{steps.X.json}` interpolation limitation; explicit context file paths or single-agent consolidation for specialist handoff | med | new | defer | C-misc | taskflow ownership unclear (pi-side, not in dotdev canon); defer pending owner |
| SB-119 | 2026-08-18 | 1 | 2026-08-06-ae-152-review-and-doc | sql-review (or repo-local dbt review lane) | Migration-review check: when an incremental model redefines `unique_key`, check every downstream model reusing that key (column ORDER is a non-concern — `on_schema_change` is name-set based) | med | new | defer | C-misc | High-value catch (orphaned-key blocker) but dbt-repo-leaning; owner decision (canonical sql-review vs astronomer lane) at dispatch |
| SB-120 | 2026-08-18 | 1 | 2026-08-13-herdr-auto-naming | herdr | Note that the auto-naming extension (`herdr-task-naming.ts`) exists, so agents don't hand-name panes the extension already covers | low | new | implement | C26 | C26 occ→3; ride the next herdr docs edit (SB-052) |
| SB-121 | 2026-08-18 | 1 | 2026-08-12-operator-console-cli | decision-log | "Mark capability DONE" recipe template | low | new | defer | C-misc | Singleton nicety |
| SB-122 | 2026-08-18 | 1 | 2026-08-11-workboard-sync-github-forgejo-divergence | workflow-finalize | When user grants merge authority and gates pass, execute merge without re-asking | low | new | defer | C-misc | Interacts with C30 taxonomy (landed) + D-006 merge gate; wait for recurrence under the new gates |
| SB-123 | 2026-08-18 | 1 | 2026-08-13-herdr-auto-naming | herdr-auto-naming (extraction) | Auto-name herdr panes from first user message / goal events | med | implemented | — | CZ | **Built in-session as pi extension `~/.pi/agent/extensions/herdr-task-naming.ts` — extension, not a skill; event-name verification tracked in the chorus/pi repo, out-of-pipeline** |
| SB-124 | 2026-08-18 | 1 | 2026-08-10-warren-entity-pivot | workflow-build-one (DELETED) | Verify test data exists | low | superseded | — | C-misc | **2026-08-25: workflow-build-one deleted (use workflow-deliver)** | defer | C-misc | Singleton; author-rated low |
...
**2026-08-18 harvest additions (repo-local, recorded for the owning repos' retros):**

- **chorus/pergamon**: `infra/litellm/README.md` verify-model-names section + virtual-keys-need-db note; `infra/litellm/scripts/verify-models.sh`; `docs/runbooks/litellm-migration.md` Anthropic-SDK (`ANTHROPIC_BASE_URL`, `/v1/messages`) + health-401-when-master-key sections; `docs/runbooks/shell-wrappers.md` (export gotcha); `docs/agents/rowan/README.md` rowan-vs-brain routing split; `docs/roadmap.md` blockers column; `chorus send/inbox` CLI (**likely landed** — built in the 2026-08-12 operator-console session); `scripts/chorus/sync_board.py` ×3 (`.get("tasks") or []`, label auto-create, label-when-comment-exists); `docs/decision-log.md` F78 GitHub-vs-Forgejo authority (**likely landed** — F78 recorded per 08-12 hermes reflection); `~/.chorus/docs/forgejo-api-reference.md` (v15 vs v16 API, tunnel ports 3000/3001, token scopes).
- **astronomer (dbt)**: `document-dbt-model` — forbid path-echo descriptions; read source schema before describing timestamp/derived columns (corrections #1/#2, 2026-08-06).
- **warren**: `eslint.config.js` allowDefaultProject glob for `src/client/**/*.tsx`.
- **pi infra**: upstream/fork the `pi-herdr-subagents` `--token task=X` fix (node_modules patch is ephemeral); verify `herdr-task-naming.ts` event names.
...
## 2026-08-18 harvest — ranked queue (NO DISPATCH this run; Track D of D-006 is harvest+triage only)

Decision queue for a future dispatch run (Step 4 approval still required then). D-006-consumed rows are excluded — they land via the D-006 phase plan, not workflow-skill dispatches.

1. **C42 residual** (occ 5, high): SB-099 (habits.md proxy-vs-ground-truth line) + SB-100 (i-have-adhd verification rule) — cheap, two files.
2. **C47** (occ 2, high): SB-111 + SB-112 — one ponytail-rules dispatch (owner file TBD: pi persona vs habits.md).
3. **C43/C-ext** (occ 2, high): SB-102 `external-tool-compatibility` extraction (absorbs 2 workflow checkboxes; standalone-vs-build-one open q).
4. **C-ext** (occ 1, high): SB-103 `airflow-failure-rca` extraction (verify `error_detail` generality first).
5. **C48** (occ 1, high): SB-113 (habits.md inherited-constraint line) — could ride the SB-099 habits.md edit.
6. **C44 residual** (med): SB-105 handoff env-assumption notes.
7. **C45** (med): SB-108 cleanup-delivery reconcile-primary action.
8. **Lower**: SB-116 setup-mcp-server extraction; SB-120 herdr note (ride SB-052).
9. **Deferred**: SB-101/106/107/114/115/118/119/121/122/124.
...
***DONE 2026-08-18:** FIND-09 **closed as remediated** — no new rewrite needed: the 2026-07-09 filter-repo pass had already cleaned origin (fresh-clone verified); the "still open" signals were a stale local `v0.1.0` tag resurrecting the pre-rewrite line (fixed: re-pointed to origin's target) plus GitHub-side persistence (22 `refs/pull/*/head` + SHA-fetchable blob — GitHub Support is the only purge path; Alex decides). Key confirmed dead at operator gate; no rotation. Evidence + support-request draft: `docs/audits/2026-08-18-find-09-remediation.md`; decision: DL-0018.*

## 2026-08-25 Triage Summary

**Session context:** Deleted 71 skills, simplified workflow-router by 50%, added Hook Rules A-H.

### Superseded (18 items) — target skills deleted this session

SB-024, SB-032, SB-033, SB-040, SB-041, SB-042, SB-062, SB-079, SB-081, SB-082, SB-088, SB-098, SB-109, SB-114, SB-124

### Folded (12 items) — covered by this session's work

SB-036, SB-064-069, SB-071, SB-075, SB-083, SB-085

### High-priority queue (8 items) — **ALL IMPLEMENTED 2026-08-25**

| ID | Target | Summary | Status |
|---|---|---|---|
| SB-052 | herdr | Document herdr commands | ✅ |
| SB-054 | improve-codebase-arch | Distinguish test-gap vs human-gate | ✅ |
| SB-099 | habits.md | Proxy vs ground-truth one-liner | ✅ |
| SB-100 | i-have-adhd | Show verification evidence rule | ✅ |
| SB-105 | handoff | Env-assumption notes (gh vs forge) | ✅ |
| SB-108 | cleanup-delivery | Reconcile-primary action | ✅ |
| SB-111+112 | ponytail/habits | YAGNI boundary + blast-radius | ✅ |
| SB-113 | habits.md | Inherited-constraint verification | ✅ |

### Deferred (~20 items) — low value or singleton

SB-030, SB-031, SB-034, SB-051, SB-053, SB-056, SB-072-074, SB-076-078, SB-080, SB-084, SB-086-087, SB-089, SB-091-094, SB-101, SB-106-107, SB-115-122
