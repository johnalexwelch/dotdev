...
| SB-024 | 2026-07-17 | 1 | 2026-07-17-skill-pipeline-habits-openwiki | workflow-skill (DELETED) | Claude-runtime breakage → hard report | med | superseded | — | C8 | **2026-08-25: workflow-skill deleted this session** |
...
| SB-036 | 2026-07-19 | 2 | multi | CLAUDE.md | habits.md pointer | high | folded | — | C9 | **2026-08-25: Already in global CLAUDE.md (this session)** |
...
| SB-040 | 2026-07-20 | 1 | 2026-07-20-path-guard-phase3 | execute-phase (DELETED) | Git-history precedent stale | med | superseded | — | C16 | **2026-08-25: execute-phase deleted this session** |
...
| SB-071 | 2026-07-28 | 1 | multi | workflow-finalize | Clean-state exit gate | high | folded | — | C31 | **2026-08-25: Covered by Hook Rule C (PR body gate)** |
...
| SB-073 | 2026-07-28 | 1 | 2026-07-27-cleanup-delivery-merged-worktrees | cleanup-delivery | Handoff-only-branch bucket (clean pushed, no PR, handoff payload → explicit keep/PR/delete) | med | new |
| SB-074 | 2026-07-28 | 2 | 2026-07-27-cleanup-delivery-merged-worktrees, 2026-07-27-pergamon-phase6-backlog-cleanup | cleanup-delivery | Primary-checkout sync/dirty as standard report line + dirty-handoff/docs-drift class distinct from active-impl dirty | med | new |
| SB-075 | 2026-07-28 | 1 | multi | cleanup-delivery | Approval phrase + will-not-touch list | med | folded | — | C31 | **2026-08-25: Covered by session cleanup work** |
...
| SB-079 | 2026-07-28 | 2 | multi | git-guardrails (DELETED) | gh auth switch pattern | low | superseded | — | C33 | **2026-08-25: git-guardrails deleted this session** |
...
| SB-081 | 2026-07-28 | 2 | multi | workflow-build-one (DELETED) | Delegate after exhausting progress | med | superseded | — | C34 | **2026-08-25: workflow-build-one deleted (use workflow-deliver)** |
| SB-082 | 2026-07-28 | 1 | 2026-07-27-pergamon-openbao-secret-key | workflow-debug (DELETED) | Live check before repeating analysis | high | superseded | — | C34 | **2026-08-25: workflow-debug deleted this session** |
| SB-083 | 2026-07-28 | 1 | multi | habits.md | Discard queued closeout on pivot | med | folded | — | C34 | **2026-08-25: Covered by i-have-adhd always-on (restate state every turn)** |
...
| SB-085 | 2026-07-28 | 1 | multi | habits.md | Never suppress mutating stderr | high | folded | — | C36 | **2026-08-25: Covered by workflow-guard hook infrastructure** |
...
| SB-088 | 2026-07-28 | 1 | 2026-07-27-pergamon-phase6-backlog-cleanup | workflow-autonomous-backlog (DELETED) | Existing-PRD fast path | high | superseded | — | C38 | **2026-08-25: workflow-autonomous-backlog deleted this session** |
...
| SB-114 | 2026-08-18 | 1 | 2026-08-10-warren-pivot-insight | workflow-feature (DELETED) | Goal vs approach checkpoint | med | superseded | — | C48 | **2026-08-25: workflow-feature deleted this session** |
...
| SB-124 | 2026-08-18 | 1 | 2026-08-10-warren-entity-pivot | workflow-build-one (DELETED) | Verify test data exists | low | superseded | — | C-misc | **2026-08-25: workflow-build-one deleted (use workflow-deliver)** |
