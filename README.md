...
`AGENTS.md`/`CLAUDE.md` at repo root just point there. `AI_ENVIRONMENT.md` and `SETUP_WRITEUP.md` below predate
OpenWiki and are being folded in; treat `openwiki/` as the source of truth where they disagree.
